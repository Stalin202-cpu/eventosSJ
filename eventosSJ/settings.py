"""
Django settings for eventosSJ project.
...
SECRET_KEY = 'django-insecure-565!vl=($5u60-^4oy3)kl#54%_08l9(3u*+$-fa$aq8%e5tpo'
...
WSGI_APPLICATION = 'eventosSJ.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS=(os.path.join(BASE_DIR,'eventosSJ/static/Plantilla'),)
